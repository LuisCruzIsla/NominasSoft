 ...
 * @author LuisCriz
 */
public class ContratoDAOSQLite implements IContratoDAO{
    
    private GestorJDBC gestorJDBC;

    public ContratoDAOSQLite(GestorJDBC gestorJDBC) {
    ...
    private Contrato buscar(String empleadoID, boolean antepenultimo) throws SQLException {
        ...
        if(resultadoContrato.next()){            
            ...
            //Set AFP
            afpdao = new AFPDAOSQLite(gestorJDBC);
            int afpid = resultadoContrato.getInt("afpid");
            afp = afpdao.buscar(afpid);
            contrato.setAfp(afp);
            
            //Set Empleado
            empleadoDAO = new EmpleadoDAOSQLite(gestorJDBC);
